...
if __name__ == '__main__':
    ...
    print "starting"
    while not os.path.exists('/tmp/raspifastcamd.pid'):
        time.sleep(1.0)
    print "raspifastcamd started"
    ...
    imfile = "/tmp/camcap.jpgi"  # something is screwy with this....
    ...
    while True:
        ...
        # raw_str(vis, (20, 20), 'time: %.1f ms' % (dt*1000))
